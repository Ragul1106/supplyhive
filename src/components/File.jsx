...
import banner from "../assets/images/f_banner.jpg";
...
const Files = () => {
    useEffect(() => {
        document.title = "Files | SupplyHive";
    }, []);
    ...
    const filteredProducts = fileProducts.filter((p) => {
        ...
        <div className="min-h-screen mt-30">
            <div className="w-full mb-6">
                <img
                    src={banner}
                    alt="Office Banner"
                    className="w-full md:h-100 p-2 object-contain md:object-cover max-w-5xl mx-auto rounded-2xl"
                />
                ...
                >
                    ...
                    <div className="bg-[#097afa] px-6 py-2 mb-10 rounded-xl text-white">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/files" className="cursor-pointer text-black font-bold hover:underline" onClick={() => setSidebarOpen(false)}>Files & Folders</Link></li>
