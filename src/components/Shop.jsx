...
const OfficeBasics = () => {
  ...
  const filteredProducts = officeProducts.filter((p) => {
        ...
        >
          ...
          <div className="bg-[#097afa] px-6 py-2 mb-10 rounded-xl text-white">
            ...
            <ul className="space-y-2">
              <li><Link to="/shop" className="cursor-pointer text-black font-bold hover:underline" onClick={() => setSidebarOpen(false)}>Office Basics</Link></li>
