...
//   const handleSubmit = () => {
//     // Basic validation: require at least 1 star or a comment
...
//                 className="rounded-lg bg-[#1877F2] px-4 py-2 text-white font-semibold hover:bg-[#1467cf] focus:outline-none focus:ring-4 focus:ring-blue-300"
//               >
//                 Submit
//               </button>
//             </div>
...
//     // Persist if needed (localStorage or API). Example:
//     // const existing = JSON.parse(localStorage.getItem("reviews") || "[]");
//     // existing.push({ productName, rating, comment, date: new Date().toISOString() });
...
//                 onClick={() =>
//                   openReview(cartItems[0]?.name || "Purchased product")
//                 }
//               >
