...
import banner from "../assets/images/p_banner.jpg";
...
const Paper = () => {
    ...
    const filteredProducts = paperProducts.filter((p) => {
        ...
        <div className="min-h-screen mt-30">
            <div className="w-full mb-6">
                <img
                    src={banner}
                    alt="Office Banner"
                    className="w-full  md:h-80 p-2 object-cover max-w-5xl mx-auto rounded-lg "
                />
                       ...
                       >
                         ...
                         <div className="bg-[#097afa] px-6 py-2 mb-10 rounded-xl text-white">
                           ...
                           <ul className="space-y-2">
                             ...
                             <li><Link to="/paper" className="cursor-pointer text-black font-bold hover:underline" onClick={() => setSidebarOpen(false)}>Paper & Notebooks</Link></li>
